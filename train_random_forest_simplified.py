#!/usr/bin/env python3
"""
NOAA Random Forest Training - Simplified Version
Uses test-mode parameters on full 88M training data
Memory-optimized with 2-fold CV and sequential training
"""
import sys, time
...
# Parse arguments
if len(sys.argv) < 3:
    print("Usage: train_random_forest_simplified.py <train_parquet_path> <output_path>")
    sys.exit(1)
...
print("=" * 80)
print("NOAA Random Forest Training - Simplified Version")
print("=" * 80)
...
# -------------------- Hyperparameter Grid --------------------
print("\nHyperparameter Grid (Test-Mode Parameters):")
print("  Using same parameters that succeeded in RF Test:")
print("    - numTrees: [10, 20]")
print("    - maxDepth: [5, 10]")
...
# -------------------- Train --------------------
print("\n" + "=" * 80)
print("Training Random Forest with 2-Fold Cross-Validation")
print("=" * 80)
print("Expected runtime: ~1.5-2.5 hours")
