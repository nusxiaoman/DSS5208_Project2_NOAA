"""
Random Forest Training Script for NOAA Weather Data
Trains Random Forest Regression model with hyperparameter tuning
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Usage: train_random_forest.py <train_path> <output_path> [mode]")
    ...
    spark = SparkSession.builder \
        .appName("NOAA Random Forest Training") \
        .config("spark.sql.adaptive.enabled", "true") \
        .getOrCreate()
    
    print("=" * 80)
    print("NOAA Weather Prediction - Random Forest Regressor")
    print("=" * 80)
    ...
    if mode == 'test':
        ...
        paramGrid = ParamGridBuilder() \
            ...
            .build()
        numFolds = 3
        print("Full mode: 3 x 3 x 2 = 18 models, 3-fold CV")
    ...
    print("(This may take 20-40 minutes for test mode, 2-4 hours for full mode)")
    ...
    metrics_df = spark.createDataFrame(
        metrics_data,
        ["model", "mode", "train_rows", "num_trees", "max_depth",
